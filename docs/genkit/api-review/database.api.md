...
// @public
export function setPriority(ref: DatabaseReference, priority: string | number | null): Promise;

// @public
export function setWithPriority(ref: DatabaseReference, value: unknown, priority: string | number | null): Promise;
